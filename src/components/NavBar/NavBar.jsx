...
const NavBar = ({ showCart, cartCount }) => {
  ...
  const navList = <ul className={classes['nav-list']}>
    <a href='/ecommerce-product-page'><li className={classes['list-item']}>collections</li></a>
    <a href='/ecommerce-product-page'><li className={classes['list-item']}>men</li></a>
    <a href='/ecommerce-product-page'><li className={classes['list-item']}>women</li></a>
    <a href='/ecommerce-product-page'><li className={classes['list-item']}>about</li></a>
    <a href='/ecommerce-product-page'><li className={classes['list-item']}>contact</li></a>
  </ul>
  ...
  return (
    <nav>
      <div className={classes.heading}>
        ...
        <a href='/ecommerce-product-page'><h1>sneakers</h1></a>
      </div>
      {showSidebar &&
        <React.Fragment>
